<div class="container">
  <h5><b>Fornecedores</b></h5>
  <a class="btn btn-info" href="fornecedor.php?acao=novo">Novo</a>
  <a class="btn btn-info" href="pdf_fornecedor.php">Relatório</a>
        ...
        <?php foreach ($registros as $linha): ?>
          <tr>
            ...
            <td style="text-align: end">
                <a class="btn btn-info btn-sm" href="../informacoes/informacoes.php?acao=listar&codFornecedor=<?php echo $linha['codFornecedor']; ?>">Informações</a>
